...
export default function Home() {
  ...
  // Always show spinner until we KNOW the user is authenticated
  // This prevents the flash of the upload page before redirect
      ...
      <main style={{maxWidth:560,margin:"0 auto",padding:"80px 24px 0"}}>
        ...
        <div
          ...
          style={{border:drag?"1.5px dashed #999":file?"1.5px dashed #bbb":
            ...
            textAlign:"center",
            background:drag?"#f5f5f5":file?"#fafafa":"#fff",
        ...
        <button
          ...
          style={{width:"100%",padding:"15px 24px",borderRadius:12,
            border:"none",
            background:(!file||loading)?"#e8e8e8":"#111",
        ...
        {[["Browse templates","grid_view"],
          ...
          <button key={label}
            style={{width:"100%",padding:"14px 18px",background:"#fff",
              border:"1px solid #ebebeb",borderRadius:12,display:"flex",
